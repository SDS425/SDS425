...
hist(data$N_Stations, breaks = 100, main ="Histogram of total Chargers")

y <- data_sample$N_Stations
          
x <- data.matrix(data_sample[, -c('EV.Level1.EVSE.Num', 'EV.Level2.EVSE.Num', 'EV.DC.Fast.Count', 'N_Stations')])
